...
import { ExtensionSlot , ComponentsState, ErrorComponentsState, Menu, Notifications, SwitchErrorInfo, MenuItemProps,  } from 'piral';
...
export const layout: Partial<ComponentsState> = {
  ...
  Layout: ({ children }) => (
    <div className='container'>
      <Notifications />
      <div id="top-menu" className='navbar navbar-light navbar-expand-sm navbar-toggleable-sm ng-white border-bottom box-shadow mb-3' >
        <ExtensionSlot name="top-menu" />
      </div>
